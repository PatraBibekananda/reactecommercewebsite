    ...
    <Nav>
        <div className={menuIcon ? 'navbar active' : 'navbar' }>
            <ul className='navbar-lists'>
                ...
                { isAuthenticated && <h3>Hii {user.name}</h3> }
                { isAuthenticated ? 
                    <li>
                ...
                <li>
                    ...
                    <span className='cart-total--items'> { isAuthenticated ? total_item : "0" } </span>
                    </NavLink>
                </li>
            </ul>
            ...
            <div className='mobile-navbar-btn'>
                ...
                <CgClose name="close-outline" className="mobile-nav-icon" onClick={() => setMenuIcon(false)} />
            </div>
        </div>
    </Nav>
  )
